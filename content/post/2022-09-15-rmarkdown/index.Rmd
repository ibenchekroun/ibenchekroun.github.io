...
Every year, a few movies (and TV shows) garner an unusually high volume of terrible ratings on IMDb. The first time I took note of such "review bombing" was in 2016 with the release of the female-led [Ghostbusters (2016)](https://www.imdb.com/title/tt1289401/?ref_=nv_sr_srsg_6) reboot ([source](https://screencrush.com/ghostbusters-imdb-what-the/)). The ratings were so unusual that IMDb decided to evaluate the film's rating with an ["an alternate weighting calculation"](https://www.imdb.com/title/tt1289401/ratings/?ref_=tt_ov_rt) and it now has a solid 6.9/10.     
...
The goal of this post is to use my amateur web scraping skills to explore the following question:<font size="5"> <strong> are specific kinds of movies more likely to encounter hate on IMDb than others? </strong> </font> Are movies with a woman lead more likely to be hated on than movies with a non-woman lead? How about if the two leads are women? If it was (co-)written by a woman, or (co-)directed by a woman? I'll also look into non-gender variables obtainable on IMDb. The full list of variables considered, with their definitions, is displayed in the [Glossary](Glossary).   

### How do we measure hate? What constitutes a hated movie?  

By my choosing, <font size="3"> <strong> a movie's hate will be measured by the proportion of IMDb ratings that are 1/10</strong> </font>. The more 1/10 ratings a movie gets, the more hated it is. For this analysis, a movie will be considered to be 'Hated' if it is among the 100 films with the highest proportion of 1/10 IMDb ratings. Again, classifying movies into Hated or Not Hated was a personal choice, and the way to define a Hated movie as well. In this way, we can look at each kind of movie (eg woman-led, Horror, etc) and find the proportion of them that are Hated, giving us a naive estimate for the probability of hating a specific kind of movie. An alternative analysis I considered was to instead determine the average degree of Hate for each specific kind of movie. My belief is that the most extreme cases of IMDb hate are more likely to reveal bias user prejudice than a mean or median of all movies. I'm curious whether looking at the mean/median hate will give similar results, though, so at the end I also try that approach to compare. 

#### Grouping movies by Metascore Rating
Of course, a movie with a high proportion of 1/10s could simply be a terrible movie (as the "What about Kill Bill and Wonder Woman" crowd would argue). My proposed solution to differentiate the terrible movies from the not terrible movies is by separating movies based on their Metacritic's Metascore Ratings. Metacritic splits movies into [three tiers](https://www.metacritic.com/about-metascores): 1. Metascore between 61-100, 2. Metascore between 40-60 and 3. Metascore between 1-39. From hereafter, the 3 groups will be referred as Favourable, Mixed, and Unfavourable movies, respectively for brevity's sake. Since movies are grouped with similarly-rated films, those with more 1/10 ratings can be interpreted as more hated rather than worse in quality. 

##### Why Metascore?    
<span style="color:grey"> 
<font size = "2"> If you do not care, please skip right to [Films included in analysis]. 
<span style="color:grey"> 
<font size = "2">    
...
Maybe you don't. If it helps convince you, below is a chart of the Metascore ratings of the 2400+ movies released between 2000 and 2019 that received 50K+ IMDb ratings; please <b> feel free to hover over movies with high, medium, and low metascores </b>. Or in the table below (Table 1), <b> feel free to look up the title of any movie in the Search bar to see its Metascore rating </b>. </font>
...
If you do not care, please skip right to [Results].    
...
* Unfavourable films show the least correlation between IMDb hate and any of the movie traits. This supports the idea that critically disliked films <i> earn </i> their 1/10 ratings on IMDb; the hate is based on actual movie quality rather than any prejudice. 
...
It was also insightful to look at the not-so-great man-led movies, which don't get punished as much as the not-so-great woman-led movies. These critically average movies reveal more gender-based biases than the critically acclaimed ones; they are more likely to be hated when i) the lead actor is a woman, ii) the two lead actors are women, and also when iiii) one of the writers is a woman.
...
In conclusion, yes Wonder Woman wasn't hated. That's great. It doesn't contradict the result that woman-led films are hated than man-led films, a finding made more unfortunate by the fact that more movies star men than women (though I'm sure this is not a coincidence). As a next step, I would like to dig into why Wonder Woman wasn't met with as much hate. What about Wonder Woman and Kill Bill made them okay to IMDb voters? 

### Horror and Auteur biases
Critically liked horror films and auteur movies seem to attract more hate than normal as well. From my experience, some horror fans just want to be scared or to have fun, and don't care so much for a well-crafted narrative. That's the best explanation I got for horror. I find the results on auteur movies interesting as it's the variable I created with the most personal discretion.   
